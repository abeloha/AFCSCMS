		...
		<div class="tab-content"> 
            ...
            <div class="d-flex justify-content-between align-items-center ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form method="POST" action="{{url('mail/sent')}}" enctype="multipart/form-data">
                        <div class="input-group" style="padding-top: 12px;">
                            @csrf 
                            <input type="text" name="s" class="form-control" value="{{$search}}" placeholder="What do you want to find in your sent mails?">
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="submit">Search Sent Mail</button>
                            </div>
                        </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link" id="Primary-tab" href="{{url('mail')}}">Inbox</a></li>
                            <li class="nav-item"><a class="nav-link active" id="Social-tab" href="{{url('mail/sent')}}">Sent Mails</a></li>
            ...
            <div class="tab-pane fade show active" id="Primary">
                <div class="accordion" id="accordionExample">
                        ...
                        @foreach($messages as $message)
                            <?php 
                                ...
                                if($count_recipients){
                                    ...
                                    $recipient_name = $first_recipient->surname.' '.$first_recipient->first_name;
                                    $remaining = $count_recipients - 1;
                                    if($remaining > 0){
                                        $recipient_name .= " (+ $remaining)";
                                    }
                                }
                            ...
                            <div class="card inbox">                        
                                <div class="card-header" id="headingOne">
                                        ...
                                        <h5 class="mb-0">
                                            <a href="{{url('mail/view/'.$message->id)}}"><button class="btn btn-link" type="button">{{$recipient_name}}</button></a>
                                        </h5>
                    ...
                    @else
                        ...
                        @else
                            <p><i>You haven't sent any mail yet.</i></p>
                        @endif
