			...
			<div class="tab-pane active" id="Library-all">
                ...
                @if($added)
                    <div class="alert alert-info">
                        <p>New Term has been added successfully</p>
                    </div>
                @endif
                                    ...
                                    <tbody>
                                        @foreach($terms as $term)
                                            <?php
                                                ...
                                                $courses = get_course($term->course_id);
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$term->name}}</td>
                                                <td>{{$course}}</td>
                                                <td>{{($term->is_joint)? 'yes' : 'No'}}</td>
                                                <td>{{$term->created_at}}</td>
                                                <td>
                                                    <a href="{{url('term/'.$term->id.'/delete')}}" onclick="return confirm('Are you sure you want to delete this record?')"><button type="button" class="btn btn-icon btn-sm" title="Delete"><i class="fa fa-trash-o text-danger"></i></button></a>
                                                </td>
                                            </tr>
                                        @endforeach                                        
                                    </tbody>
                                ...
                                <div class="row">                            
                                    ...
                                    <div class="form-group">
                                        <label class="custom-control custom-checkbox">
                                            ...
                                            <span class="custom-control-label">This is a joint term</span>
                                        </label>
                                    </div>
