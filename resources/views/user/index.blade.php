                        ...
                        @if($unauthorised)
                            <div class="col-md-12">
                                <div class="alert alert-danger">
                                    <p>You do not have authorization for the action</p>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="card">
                                <div class="card-body w_user">
                                    <div class="user_avtar">
                                        ...
                                        ?>
                                        <img class="rounded-circle" src="{{asset('storage/user/'.$img)}}" alt="">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <b>First Name </b>
                                            <div class="pull-right">{{$data->first_name}}</div>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Other Name </b>
                                            <div class="pull-right">{{$data->other_name}}</div>
                                        </li>						
                                        <li class="list-group-item">
                                            <b>Appointment </b>
